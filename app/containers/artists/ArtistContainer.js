...
class ArtistContainer extends Component {
    ...
    async UNSAFE_componentWillMount(){
        ...
        await fetch(global.server_url + '/api/artist_songs/' + params.artist.id, {
            method: 'GET',
            headers: {
    ...
    render() {
        const { artist, items, options} = this.state
                    ...
                    renderBackground={() => (
                         <View key="background">
                            <Image resizeMode="cover" style={styles.imageBackground} 
                                source={{ uri: artist.picture ? artist.picture : "" }} />
                        </View>
                    )}
                renderForeground={() => (
                        ...
                        <TouchableOpacity activeOpacity={0.8}>
                            <View style={styles.avatarContainer}>
                                <ImageBoxView
                                    ...
                                    isRadius
                                    boxSize="md"
                                    source={artist.picture ? { uri: artist.picture } : ""}
                                />
                            </View>
